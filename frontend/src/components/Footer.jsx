      ...
      <div className="max-w-[1400px] mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center py-12 border-b border-[#222] gap-10">
          ...
          <div className="flex gap-4">
              ...
              <a href="https://github.com/Paradoxdevx" target="_blank" className="border border-[#333] p-3 text-[#888] hover:bg-[#111] hover:text-white hover:border-[#555] transition-all rounded-sm flex items-center justify-center">
                <Github size={18}/>
              </a>
